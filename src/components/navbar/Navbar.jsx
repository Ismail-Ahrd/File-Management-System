            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:items-center md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    
                    {
                        ...
                        <>
                            <li>
                                <Link to={`/dashboard/${currentUser.uid}`} className={current == "/dashboard" ? currentLinkStyle :linkStyle} >
                                    Dashboard
                                </Link>
                            </li>
                            <li>
                        ...
                        <>
                            <li>
                                <Link to="/login" className={current == "/login" ? currentLinkStyle :linkStyle} >
                                    Login
                                </Link>
                            </li>
                            <li>
                                <Link to="/register" className={current == "/register" ? currentLinkStyle :linkStyle}>
                                    Sign up
                                </Link>
                            </li>
                        </>
